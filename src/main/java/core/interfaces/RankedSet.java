 ...
 *
 * <p>This is the seam that lets {@link core.ensemble.EnsembleOrderedSet} accept members that are
 * <em>not</em> strategy-driven {@code RedBlackTree}s — e.g. the weight-balanced persistent engine
 * via {@link core.PersistentRankedSet}. {@link core.OrderedSet} implements it with its existing
